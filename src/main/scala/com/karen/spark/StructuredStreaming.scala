...
import com.karen.spark.Utilities._
...
object StructuredStreaming {
  ...
  def main(args: Array[String]) {
    ...
    val spark = SparkSession
      ...
      .config("spark.sql.streaming.checkpointLocation", "file:/home/karen/Downloads/checkpoint/")
      .getOrCreate()

    setupLogging()

    // Create a stream of text files dumped into the logs directory
    val rawData = spark.readStream.text("/home/karen/Downloads/SparkScalaMaterials/logs")
