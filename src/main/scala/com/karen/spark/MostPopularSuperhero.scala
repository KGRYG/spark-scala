...
object MostPopularSuperhero {
  ...
  def main(args: Array[String]) {
    ...
    val names = sc.textFile("/home/karen/Downloads/SparkScalaMaterials/Marvel-names.txt")
    val namesRdd = names.flatMap(parseNames)
    
    // Load up the superhero co-apperarance data
    val lines = sc.textFile("/home/karen/Downloads/SparkScalaMaterials/Marvel-graph.txt")
